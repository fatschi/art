...
public class MyRequestProcessorFactoryFactory implements
    ...
    private final RequestProcessorFactory lshRunnerFactory =
      new LSHRunnerRequestProcessorFactory();
    private final RequestProcessorFactory featureGeneratorFactory =
    	      new FeatureGeneratorRequestProcessorFactory();
    private final LSHRunner lshRunner;
    private final FeatureGenerator featureGenerator;

    public MyRequestProcessorFactoryFactory(LSHRunner lshRunner, FeatureGenerator featureGenerator) {
    ...
    private class FeatureGeneratorRequestProcessorFactory implements RequestProcessorFactory {
        public Object getRequestProcessor(XmlRpcRequest xmlRpcRequest)
            throws XmlRpcException {
