...
public class IntegerListFeatureVector implements FeatureVector<Integer>{
	private Integer id;
	private List<Integer> features;
	private SignatureVector localitySensitiveHashed;
	
	public IntegerListFeatureVector(Integer... features){
	...
	public IntegerListFeatureVector(Integer id, Integer... features){
		this(features);
		this.id = id;
	}
